...
// Phasing
set transferAngle to 180 - (transferTime / target:orbit:period * 360).
...
set targetAngle to mod(target:orbit:LongitudeOfAscendingNode + target:orbit:ArgumentOfPeriapsis + target:orbit:trueanomaly, 360).
