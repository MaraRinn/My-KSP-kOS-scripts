...
lock positionVector to PositionAt(Body, time:seconds).
...
// Arrows
set progradeArrow to vecdraw(V(0,0,0), progradeVector:Normalized * 100, green, "prograde", 1, true, 0.2).
set normalArrow to vecdraw(V(0,0,0), normalVector, purple, "normal", 1, true, 0.2).
set radialArrow to vecdraw(V(0,0,0), radialVector, cyan, "radial", 1, true, 0.2).
...
set positionArrow to vecdraw(V(0,0,0), positionVector, blue, "position", 1, true, 0.2).
set oppositionArrow to vecdraw(V(0,0,0), -positionVector, blue, "axis", 1, true, 0.2).
